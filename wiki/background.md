...
> A _complete binary tree_ `T` of height `h` satisfies the following properties:
...
By efficiently, we mean without traversing the <math>2<sup>h</sup></math> nodes of the tree.
